...
export class FragmentController implements RESTController {
  async getAll(req: Request, res: Response) {
    try {
      ...
      res
        .status(500)
        .json({ message: "Something went wrong getting all the fragments." });
    }
  }
  ...
  async getByID(req: Request, res: Response) {
    try {
      ...
      res
        .status(500)
        .json({ message: "Something went wrong getting the fragment by id." });
    }
  }
  ...
  async create(req: Request, res: Response) {
    try {
      ...
      res
        .status(500)
        .json({ message: "Something went wrong creating the fragment." });
    }
  }
  ...
  async updateByID(req: Request, res: Response) {
    try {
      ...
      res
        .status(500)
        .json({ message: "Something went wrong updating the fragment." });
    }
  }
  ...
  async deleteByID(req: Request, res: Response) {
    try {
      ...
      res
        .status(500)
        .json({ message: "Something went wrong removing the fragment." });
    }
    // res.sendStatus(501);
  }
}
