...
export class WordController implements RESTController {
  ...
  async getAll(req: Request, res: Response) {
    try {
      ...
      res
        .status(500)
        .json({ message: "Something went wrong getting all the words." });
    }
  }
  ...
  async getByID(req: Request, res: Response) {
    try {
      ...
      res
        .status(500)
        .json({ message: "Something went wrong getting the word by id." });
    }
  }
  ...
  async create(req: Request, res: Response) {
    try {
      ...
      res
        .status(500)
        .json({ message: "Something went wrong creating the word." });
    }
  }
  ...
  async updateByID(req: Request, res: Response) {
    try {
      ...
      res
        .status(500)
        .json({ message: "Something went wrong updating the word." });
    }
  }
